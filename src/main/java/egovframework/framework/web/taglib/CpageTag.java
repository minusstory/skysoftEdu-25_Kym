/**
 * 0. Project		: RichFramework
 *
 * 1. FileName		: CpageTag.java
 ...
 *
 * <PRE>
 * 1. ClassName		: CpageTag
 * 2. FileName		: CpageTag.java
 ...
 * </PRE>
 */
public class CpageTag extends BodyTagSupport
{
	private static final long	serialVersionUID	= -5829934462870088291L;

	public int doAfterBody() throws JspTagException
	{
		PageNavigationTag	parent	= (PageNavigationTag) findAncestorWithClass(this, PageNavigationTag.class);

		if (parent == null) throw new JspTagException("cpage - PageNavigation error");
		int	cpage	=	Integer.parseInt(getBodyContent().getString().trim());
